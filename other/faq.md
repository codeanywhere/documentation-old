...
There is seems to be something wrong with your long-term access token, so please try removing and adding your Drive account. If that does not work please try revoking access to Codeanywhere from your Google security page located at: https and afterwards try to add it again.
...
You can't connect via FTP but you can connect with SFTP. These are the credentials you'll need: 
